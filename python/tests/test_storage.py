...
class TestInputErrors(unittest.TestCase):
    ...
    def test_empty_key(self):
        self.assertRaises(ValueError, kas.dump, {"": np.zeros(1)}, None)

    def test_2d_array(self):
        self.assertRaises(ValueError, kas.dump, {"a": np.zeros((1, 1))}, None)

    def test_3d_array(self):
        self.assertRaises(ValueError, kas.dump, {"a": np.zeros((2, 2, 1))}, None)
...
class TestRoundTripKeys(TestRoundTrip):
    ...
    """
    @hypothesis.given(key=hst.text(min_size=1))
